...
g++ -Wall -std=c++17 -I.\include -c .\src\ListClientes.cpp
...
g++ -I.\include Ticket.o Client.o Incidente.o ColaCliente.o ListClientes.o ListaTickets.o Whatsapp.o Facebook.o SupportTechnical.o main.o -o miPrograma.exe
